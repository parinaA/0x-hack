...
export declare abstract class DataType {
    ...
    encode(value: any, rules?: EncodingRules, selector?: string): string;
    decode(calldata: string, rules?: DecodingRules, selector?: string): any;
    decodeAsArray(returndata: string, rules?: DecodingRules): any[];
