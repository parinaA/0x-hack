...
var FillScenarios = /** @class */ (function () {
    ...
    FillScenarios.prototype._createAsymmetricFillableSignedOrderWithFeesAsync = function (makerAssetData, takerAssetData, makerFee, takerFee, makerAddress, takerAddress, makerFillableAmount, takerFillableAmount, feeRecipientAddress, expirationTimeSeconds) {
        return __awaiter(this, void 0, void 0, function () {
            var senderAddress, signedOrder;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this._increaseBalanceAndAllowanceWithAssetDataAsync(makerAssetData, makerAddress, makerFillableAmount)];
                    case 1:
                        _a.sent();
                        return [4 /*yield*/, this._increaseBalanceAndAllowanceWithAssetDataAsync(takerAssetData, takerAddress, takerFillableAmount)];
                    case 2:
                        _a.sent();
                        // Fees
    ...
    FillScenarios.prototype._increaseBalanceAndAllowanceWithAssetDataAsync = function (assetData, userAddress, amount) {
        return __awaiter(this, void 0, void 0, function () {
            var e_1, _a, decodedAssetData, _b, _c, _d, index, nestedAssetDataElement, amountsElement, totalAmount, e_1_1;
            return __generator(this, function (_e) {
                switch (_e.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this._increaseERC20BalanceAndAllowanceAsync(decodedAssetData.tokenAddress, userAddress, amount)];
                    case 1:
                        _e.sent();
                        return [3 /*break*/, 12];
                    case 2:
                        if (!order_utils_1.assetDataUtils.isERC721AssetData(decodedAssetData)) return [3 /*break*/, 4];
                        return [4 /*yield*/, this._increaseERC721BalanceAndAllowanceAsync(decodedAssetData.tokenAddress, userAddress, decodedAssetData.tokenId)];
                    case 3:
                        _e.sent();
                        return [3 /*break*/, 12];
                    case 4:
                    ...
                    case 6:
                        ...
                        totalAmount = amount.times(amountsElement);
                        return [4 /*yield*/, this._increaseBalanceAndAllowanceWithAssetDataAsync(nestedAssetDataElement, userAddress, totalAmount)];
                    case 7:
                        _e.sent();
                        _e.label = 8;
                    case 8:
