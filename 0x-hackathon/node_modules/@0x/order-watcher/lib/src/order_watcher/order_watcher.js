...
var OrderWatcher = /** @class */ (function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        _.each(orderAssetDatas, function (assetData) { return _this._addAssetDataToAbiDecoder(assetData); });
                        return [2 /*return*/];
                }
            });
        });
    ...
    OrderWatcher.prototype._addAssetDataToAbiDecoder = function (assetData) {
        var _this = this;
        ...
        if (order_utils_1.assetDataUtils.isERC20AssetData(decodedAssetData)) {
            ...
            _.each(decodedAssetData.nestedAssetData, function (nestedAssetDataElement) {
                return _this._addAssetDataToAbiDecoder(nestedAssetDataElement);
            });
        }
    };
    OrderWatcher.prototype._deleteLazyStoreBalance = function (assetData, userAddress) {
        var _this = this;
        ...
        switch (assetProxyId) {
            ...
            case types_1.AssetProxyId.MultiAsset:
                var decodedAssetData = order_utils_1.assetDataUtils.decodeMultiAssetData(assetData);
                _.each(decodedAssetData.nestedAssetData, function (nestedAssetDataElement) {
                    return _this._deleteLazyStoreBalance(nestedAssetDataElement, userAddress);
                });
                break;
            default:
                break;
    ...
    OrderWatcher.prototype._deleteLazyStoreProxyAllowance = function (assetData, userAddress) {
        var _this = this;
        var assetProxyId = order_utils_1.assetDataUtils.decodeAssetProxyId(assetData);
        switch (assetProxyId) {
            case types_1.AssetProxyId.ERC20:
            ...
            case types_1.AssetProxyId.MultiAsset:
                var decodedAssetData = order_utils_1.assetDataUtils.decodeMultiAssetData(assetData);
                _.each(decodedAssetData.nestedAssetData, function (nestedAssetDataElement) {
                    return _this._deleteLazyStoreProxyAllowance(nestedAssetDataElement, userAddress);
                });
                break;
            default:
                break;
