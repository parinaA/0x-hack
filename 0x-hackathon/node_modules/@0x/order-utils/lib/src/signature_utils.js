...
exports.signatureUtils = {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        assert_1.assert.isHexString('data', data);
                        assert_1.assert.isETHAddressHex('signerAddress', signerAddress);
                        exchangeContract = new abi_gen_wrappers_1.ExchangeContract(artifacts.Exchange.compilerOutput.abi, signerAddress, provider);
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        walletContract = new abi_gen_wrappers_1.IWalletContract(artifacts.IWallet.compilerOutput.abi, signerAddress, provider);
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        validatorContract = new abi_gen_wrappers_1.IValidatorContract(artifacts.IValidator.compilerOutput.abi, signerAddress, provider);
     ...
     */
    ecSignOrderAsync: function (provider, order, signerAddress) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.trys.push([1, 3, , 5]);
                        return [4 /*yield*/, exports.signatureUtils.ecSignTypedDataOrderAsync(provider, order, signerAddress)];
                    case 2:
                        signedOrder = _a.sent();
                    ...
                    case 3:
                        ...
                        return [4 /*yield*/, exports.signatureUtils.ecSignHashAsync(provider, orderHash, signerAddress)];
                    case 4:
     ...
     * @return  A SignedOrder containing the order and Elliptic curve signature with Signature Type.
     */
    ecSignTypedDataOrderAsync: function (provider, order, signerAddress) {
        return __awaiter(this, void 0, void 0, function () {
            var web3Wrapper, normalizedSignerAddress, typedData, signature, ecSignatureRSV, signatureBuffer, signatureHex, err_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        assert_1.assert.isWeb3Provider('provider', provider);
                    ...
                    case 4:
                        ...
                        if (provider.isMetaMask) {
                            throw new Error(types_2.OrderError.InvalidMetamaskSigner);
                        }
                        else {
                            throw err_2;
                        }
     ...
     */
    ecSignHashAsync: function (provider, msgHash, signerAddress) {
        return __awaiter(this, void 0, void 0, function () {
            var web3Wrapper, normalizedSignerAddress, signature, prefixedMsgHashHex, validVParamValues, ecSignatureRSV, isValidRSVSignature, convertedSignatureHex, ecSignatureVRS, isValidVRSSignature, convertedSignatureHex;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        assert_1.assert.isWeb3Provider('provider', provider);
