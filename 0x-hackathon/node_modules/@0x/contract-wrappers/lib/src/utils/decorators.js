...
var signatureRequestErrorTransformer = function (error) {
    if (_.includes(error.message, constants_1.constants.METAMASK_USER_DENIED_SIGNATURE_PATTERN) ||
        _.includes(error.message, constants_1.constants.TRUST_WALLET_USER_DENIED_SIGNATURE_PATTERN)) {
        var errMsg = types_1.ContractWrappersError.SignatureRequestDenied;
        return new Error(errMsg);
    }
    return error;
};
