...
var _loop_1 = function (abiFileName) {
    ...
    var methodsData = _.map(methodAbis, function (methodAbi, methodAbiIndex) {
        ...
        var methodData = __assign({}, methodAbi, { singleReturnValue: methodAbi.outputs.length === 1, hasReturnValue: methodAbi.outputs.length !== 0, tsName: sanitizedMethodAbis[methodAbiIndex].name, functionSignature: new utils_1.AbiEncoder.Method(methodAbi).getSignature() });
        return methodData;
    });
