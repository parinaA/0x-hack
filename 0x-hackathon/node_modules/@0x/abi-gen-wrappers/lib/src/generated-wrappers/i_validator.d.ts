...
export declare class IValidatorContract extends BaseContract {
    ...
    static deployFrom0xArtifactAsync(artifact: ContractArtifact | SimpleContractArtifact, provider: Provider, txDefaults: Partial<TxData>): Promise<IValidatorContract>;
