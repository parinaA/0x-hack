...
var DutchAuctionContract = /** @class */ (function (_super) {
    ...
    function DutchAuctionContract(abi, address, provider, txDefaults) {
        var _this = _super.call(this, 'DutchAuction', abi, address, provider, txDefaults) || this;
    ...
    DutchAuctionContract.deployFrom0xArtifactAsync = function (artifact, provider, txDefaults, _exchange) {
        return __awaiter(this, void 0, void 0, function () {
            var bytecode, abi;
            return __generator(this, function (_a) {
    ...
    DutchAuctionContract.deployAsync = function (bytecode, abi, provider, txDefaults, _exchange) {
        return __awaiter(this, void 0, void 0, function () {
