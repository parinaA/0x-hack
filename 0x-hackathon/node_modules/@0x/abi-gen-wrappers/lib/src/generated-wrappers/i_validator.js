...
var IValidatorContract = /** @class */ (function (_super) {
    ...
    function IValidatorContract(abi, address, provider, txDefaults) {
        var _this = _super.call(this, 'IValidator', abi, address, provider, txDefaults) || this;
    ...
    IValidatorContract.deployFrom0xArtifactAsync = function (artifact, provider, txDefaults) {
        return __awaiter(this, void 0, void 0, function () {
            var bytecode, abi;
            return __generator(this, function (_a) {
    ...
    IValidatorContract.deployAsync = function (bytecode, abi, provider, txDefaults) {
        return __awaiter(this, void 0, void 0, function () {
