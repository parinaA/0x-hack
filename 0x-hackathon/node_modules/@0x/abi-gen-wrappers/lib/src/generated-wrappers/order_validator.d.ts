...
export declare class OrderValidatorContract extends BaseContract {
    ...
    static deployFrom0xArtifactAsync(artifact: ContractArtifact | SimpleContractArtifact, provider: Provider, txDefaults: Partial<TxData>, _exchange: string, _zrxAssetData: string): Promise<OrderValidatorContract>;
