...
export declare class DummyERC20TokenContract extends BaseContract {
    ...
    static deployFrom0xArtifactAsync(artifact: ContractArtifact | SimpleContractArtifact, provider: Provider, txDefaults: Partial<TxData>, _name: string, _symbol: string, _decimals: BigNumber, _totalSupply: BigNumber): Promise<DummyERC20TokenContract>;
