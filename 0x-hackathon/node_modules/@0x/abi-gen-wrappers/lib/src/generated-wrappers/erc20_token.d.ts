...
export declare class ERC20TokenContract extends BaseContract {
    ...
    static deployFrom0xArtifactAsync(artifact: ContractArtifact | SimpleContractArtifact, provider: Provider, txDefaults: Partial<TxData>): Promise<ERC20TokenContract>;
