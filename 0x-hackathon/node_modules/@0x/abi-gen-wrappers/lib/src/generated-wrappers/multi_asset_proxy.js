...
var MultiAssetProxyContract = /** @class */ (function (_super) {
    ...
    function MultiAssetProxyContract(abi, address, provider, txDefaults) {
        var _this = _super.call(this, 'MultiAssetProxy', abi, address, provider, txDefaults) || this;
        _this.assetProxies = {
    ...
    MultiAssetProxyContract.deployFrom0xArtifactAsync = function (artifact, provider, txDefaults) {
        return __awaiter(this, void 0, void 0, function () {
            var bytecode, abi;
            return __generator(this, function (_a) {
    ...
    MultiAssetProxyContract.deployAsync = function (bytecode, abi, provider, txDefaults) {
        return __awaiter(this, void 0, void 0, function () {
